...
class Main():
    def __init__(self, page: Page):
        ...
        self.__consent_btn = self.page.locator('button[aria-label="Consent"]')
        self.__sign_up_login_btn = self.page.locator('a[href="/login"]')
        ...
        self.__test_cases_btn = self.page.locator('a[href="/test_cases"]').locator("nth=0")
        ...
        self.__cart_btn = self.page.locator('a[href="/view_cart"]').locator("nth=0")
        self.__view_product_btn = self.page.get_by_text('View Product').locator("nth=0")
        self.__add_to_cart_btn = self.page.locator('a[class="btn btn-default add-to-cart"]').locator("nth=0")
    ...
    def check_main_page_is_opened(self) -> None:
        ...
        if self.__consent_btn.count() > 0:
            self.__consent_btn.click()

    def click_on_sign_up_login_button(self) -> None:
        self.__sign_up_login_btn.click()
